...
// ── RPG / Gamification ────────────────────────────────────────────────────────
export const IconFire    = (p) => <I {...p}><path d="M12 12c2-2.96 0-7-1-8 0 3.038-1.773 4.741-3 6-1.226 1.26-2 3.24-2 5a6 6 0 1 0 12 0c0-1.532-1.056-3.94-2-5-1.786 3-2.791 3-4 2z" fill={p.fill || 'none'}/></I>
export const IconStar    = (p) => <I {...p}><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill={p.fill || '#D4A843'} stroke={p.fill || '#D4A843'}/></I>
export const IconTrophy  = (p) => <I {...p}><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2z"/></I>
...
// ── Economy / Shop ────────────────────────────────────────────────────────────
export const IconGem         = (p) => <I {...p}><polygon points="6 3 18 3 22 9 12 22 2 9 6 3"/><polyline points="22 9 12 9 2 9"/><line x1="12" y1="3" x2="6" y2="9"/><line x1="12" y1="3" x2="18" y2="9"/></I>
export const IconCoins       = (p) => <I {...p}><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><line x1="16.71" y1="13.88" x2="17" y2="14"/></I>
export const IconShoppingBag = (p) => <I {...p}><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></I>
...
export const IconSparkles    = (p) => <I {...p}><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></I>
...
export const IconPalette     = (p) => <I {...p}><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></I>
export const IconLightbulb   = (p) => <I {...p}><line x1="9" y1="18" x2="15" y2="18"/><line x1="10" y1="22" x2="14" y2="22"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 0 1 8.91 14"/></I>
...
export const IconWifiOff   = (p) => <I {...p}><line x1="1" y1="1" x2="23" y2="23"/><path d="M16.72 11.06A10.94 10.94 0 0 1 19 12.55"/><path d="M5 12.55a10.94 10.94 0 0 1 5.17-2.39"/><path d="M10.71 5.05A16 16 0 0 1 22.58 9"/><path d="M1.42 9a15.91 15.91 0 0 1 4.7-2.88"/><path d="M8.53 16.11a6 6 0 0 1 6.95 0"/><line x1="12" y1="20" x2="12.01" y2="20"/></I>
export const IconClock     = (p) => <I {...p}><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></I>
export const IconLoader    = (p) => <I {...p}><line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"/><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"/><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"/></I>
...
export const IconCompass   = (p) => <I {...p}><circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/></I>
export const IconVolume    = (p) => <I {...p}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/></I>

// ── Gender symbols ─────────────────────────────────────────────────────────────
export const IconMars   = (p) => <I {...p}><circle cx="10" cy="14" r="6"/><line x1="19" y1="5" x2="14.65" y2="9.35"/><line x1="15" y1="5" x2="19" y2="5"/><line x1="19" y1="5" x2="19" y2="9"/></I>
...
// ── AniEmpire Brand Icon (Crown-in-Shield) ────────────────────────────────────
export function CrownIcon({ size = 22, color = '#D4A843' }) {
  return (
    <span style={s}>
      <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
        {/* Shield body */}
        <path d="M50 8L14 24V52C14 72 30 88 50 95C70 88 86 72 86 52V24L50 8Z" fill={color} opacity="0.15" stroke={color} strokeWidth="3.5" strokeLinejoin="round"/>
        {/* Crown inside shield */}
        <polygon points="30,58 30,36 42,48 50,28 58,48 70,36 70,58" fill={color} stroke={color} strokeWidth="2.5" strokeLinejoin="round"/>
        {/* Crown base band */}
        <rect x="28" y="57" width="44" height="8" rx="3" fill={color} opacity="0.75"/>
        {/* Crown jewels */}
        <circle cx="50" cy="38" r="3" fill="#fff" opacity="0.6"/>
        <circle cx="42" cy="46" r="2" fill="#fff" opacity="0.35"/>
        <circle cx="58" cy="46" r="2" fill="#fff" opacity="0.35"/>
      </svg>
    </span>
  )
}
